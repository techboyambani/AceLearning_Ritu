...
public class student_doubt extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.student_home) {
            Intent i= new Intent(student_doubt.this,home_student.class);
            startActivity(i);
            finish();
            // Handle the camera action
        } else if (id == R.id.student_doubt) {
            Intent i= new Intent(student_doubt.this,student_doubt.class);
            startActivity(i);
            finish();

        } else if (id == R.id.student_testscore) {
            Intent i= new Intent(student_doubt.this,student_testscore.class);
            startActivity(i);
            finish();

        } else if (id == R.id.logout) {

            Intent i=new Intent(student_doubt.this,logout.class);
                startActivity(i);
             finish();


        } else if (id == R.id.changepassword) {
  Intent i=new Intent(student_doubt.this,changepassword.class);
            startActivity(i);
            finish();
