...
public class student_note_adapter extends RecyclerView.Adapter<student_note_adapter.ViewHolder> {
    TextView lectures;
    ...
    public student_note_adapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> lecs,ArrayList<String> lecs_date,ArrayList<String> lecs_url) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            super(itemView);
            lectures=itemView.findViewById(R.id.card_note);
            by=itemView.findViewById(R.id.card_note_by);
            date=itemView.findViewById(R.id.card_note_date);
